...
config :module_o_mat, ModuleOMatWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "2ziJC4o7u0q4udM41ShOC9nTadEtTxcXiZ00rvofLIh3V5R4KBudFMwwA9aWmnQx",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:module_o_mat, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:module_o_mat, ~w(--watch)]}
  ]
